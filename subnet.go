...
func (subnet *Subnet) find_info(nic string) (*Lease, *Binding) {
	subnet.lock.RLock()
	l := subnet.Leases[nic]
...
func (subnet *Subnet) find_or_get_info(nic string, suggest net.IP, hostname string) (*Lease, *Binding, bool) {
